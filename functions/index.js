...
exports.sendEmailConfirmationListItem = functions.database.ref('/list/{item}').onWrite(event => {
  const mailOptions = {
    to: 'gerry@mclarnonworld.com'
  };

  // The user unsubscribed to the newsletter.
  mailOptions.subject = 'New list item added';
  mailOptions.text = 'I hereby confirm that a new list item was added.';
  return mailTransport.sendMail(mailOptions).then(() => {
    console.log('New list item confirmation email sent to:', mailOptions.to);
  });
});
